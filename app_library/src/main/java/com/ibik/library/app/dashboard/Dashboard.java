...
public class Dashboard extends JFrame {
	...
	public Dashboard(User users) {
		...
		try {
			...
			JLabel labelTitle = new JLabel("Wellcome to the application");
			labelTitle.setForeground(Color.BLACK);
			labelTitle.setFont(new Font("Tahoma", Font.BOLD, 16));
			labelTitle.setBounds(96, 43, 236, 44);
			...
			textPassword.setBounds(206, 359, 161, 20);
			...
			textNIK.setBounds(27, 50, 150, 20);
			panel.add(textNIK);
			...
			textFullname.setBounds(206, 50, 161, 20);
			...
			textAddress.setBounds(27, 184, 340, 141);
			...
			textEmail.setBounds(27, 359, 150, 20);
			panel.add(textEmail);
